...
"></i></span>
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        ?>
                        <form id="form" class="splash-container" method="post" action="update_users.php" onsubmit="return validateMobile()">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" type="text" name="users_username" required autocomplete="off" value="<?php echo htmlspecialchars($res['users_username']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" type="email" name="users_email" required autocomplete="off" value="<?php echo htmlspecialchars($res['users_email']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <div style="position: relative;">
                                            <input id="password" class="form-control form-control-lg" type="password" required name="users_password" value="<?php echo htmlspecialchars($res['users_password']); ?>">
                                            <i id="togglePassword" class="fa-solid fa-eye" onclick="togglePassword()" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; font-size: 1.2rem;"></i>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input id="mobile" class="form-control form-control-lg" type="tel" name="users_mobile" required autocomplete="off" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="<?php echo htmlspecialchars($res['users_mobile']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" type="text" name="users_address" required autocomplete="off" value="<?php echo htmlspecialchars($res['users_address']); ?>">
                                    </div>
                                    <div class="form-group pt-2">
                                        <input type="hidden" value="<?php echo htmlspecialchars($res['users_id']); ?>" name="hidden_users_id">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($res['invoice_id'])) { ?>
                                                            <a href="download_invoice.php?invoice_id=<?php echo htmlspecialchars($res['invoice_id']); ?>"
                                                                class="btn btn-primary btn-sm mb-1" style="width: 100%;">
                                                                <i class="fas fa-file-pdf"></i> Invoice
                                                            </a>
                                                        <?php } else { ?>
                                                            <span class="text-danger small d-block mb-1">Invoice Pending</span>
                                                        <?php } ?>
                                                        <a href="track_order.php?order_id=<?php echo htmlspecialchars($res['orders_id']); ?>"
                                                            class="btn btn-info btn-sm" style="background-color: #f7a392; border-color: #f7a392; color: white; width: 100%;">
        ...
        <!-- ============================================================== -->
<?php
// flash message handling instead of alert
$flash_msg = '';
$flash_type = 'info';
if (isset($_GET['edit_success']) && $_GET['edit_success'] == 1) {
    $flash_msg = 'Details updated successfully!';
    $flash_type = 'success';
}
?>
